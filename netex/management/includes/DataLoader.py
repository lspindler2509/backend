...
class DataLoader:
    PATH_PROTEINS = 'data-NetExpander/Proteins/'
    PATH_DISORDERS = 'data-NetExpander/Disorders/'
    PATH_PDI = 'data-NetExpander/PDI/'
    PATH_PPI = 'data-NetExpander/PPI/'
    PATH_PDi = 'data-NetExpander/PDi/'
    PATH_DDi = 'data-NetExpander/DrDi/'
