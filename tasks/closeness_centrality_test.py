...
def closeness_centrality_test(algorithm, parameters):
...
if __name__ == '__main__':
    ...
    # parser.add_argument("--seeds", type=str, nargs="+", default=["SARS-CoV2_NSP14", "SARS-CoV2_NSP14"],
    ...
    parser.add_argument("--hub-penalty", type=float, default=1.0,
                        help="Hub penalty.")
    parser.add_argument("--max-deg", type=int, default=50,
                        help="Ignore hub nodes.")
    parameters = vars(parser.parse_args())
    #print(parameters)
    closeness_centrality_test(closeness_centrality, parameters)